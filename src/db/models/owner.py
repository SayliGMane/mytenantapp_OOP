...
class Owner:
    def __init__(self, flat_owner_id: int, flatno: int, bank_details: str, owner: json) -> None:
    ...
    @classmethod
    def insert_data(cls, flat_owner_id: int, flatno: int, bank_details: int, owner: json) -> Optional['Owner']:
